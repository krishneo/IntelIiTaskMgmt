...
<section id="main" class="column">
		...
		<div class="module_content">
			<article class="stats_graph">
				...
				<span style=""> &nbsp; &nbsp; &nbsp; &nbsp;</span> <span
					id="sparkline_213"> </span> <br /> Rating Per Day
				...
				<table class="tablesorter" cellspacing="0">
					...
					<tbody>
						<tr>
							...
							<td><input type="image" src="images/icn_alert_info.png"
								title="More Information"><input type="image"
								src="images/pdf_icon.jpg" title="Download Invoice"><input
								type="image" src="images/basic-icon-download.png"
								title="Pay Invoice"></td>
						</tr>
						<tr>
							<td>Lorem Ipsum Dolor Sit Amet</td>
							<td>Articles</td>
	...
	<article class="module width_full">
		<header>
			<h3 id="usage_breakdown">Usage breakdown</h3>
		</header>
		<div class="module_content">
			<fieldset>
