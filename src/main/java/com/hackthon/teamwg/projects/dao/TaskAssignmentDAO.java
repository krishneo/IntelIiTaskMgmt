...
public class TaskAssignmentDAO {
	...
	public void runTaskAssignmentAlgorithm(String group_name) throws Exception {
		...
		if("ALL".equalsIgnoreCase(group_name))
		{
			...
			for(RaasGroupsDTO obj:groups)
			{
				...
				this.invokeTaskAssignment(obj.getGroupName());
			}
		}else
			this.invokeTaskAssignment(group_name);
	...
	public List<RaasTasksDTO> invokeTaskAssignment(String group_name) throws Exception {

		List<RaasTasksDTO> unassigned_tasks = this.shuffleTasksAccordingToPriorities(group_name);
		List<RaasUsersDTO> unassigned_users = this.getListOfUnAssignedUsersInGroup(group_name);
		...
		for (RaasUsersDTO obj : unassigned_users) {
			...
			curr_task = getNextUnAssignedTasks(group_name);
			if (curr_task == null)
				break;
	...
	private List<RaasUsersDTO> getListOfUnAssignedUsersInGroup(String group_name) throws Exception {
	...
	private RaasTasksDTO getNextUnAssignedTasks(String group_name) throws Exception {
	...
	private List<RaasTasksDTO> getListOfUnAssignedTasks(String group_name) throws Exception {
	...
	private List<RaasTasksDTO> shuffleTasksAccordingToPriorities(String group_name) throws Exception {

		List<RaasTasksDTO> tasks = this.getListOfUnAssignedTasks(group_name);
	...
	public static void main(String... args) throws Exception {
		...
		tskDAO.runTaskAssignmentAlgorithm("ALL");
